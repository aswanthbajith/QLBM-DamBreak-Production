# F36 Real QPU Access & First Experimental Execution
...
- **Milestone Commit**: `a012a75` (Phase F35)
- **Automated Test Suite**: **324 / 324 Passing Tests**.
...
\hline
\text{Density Error } (L_1) & \text{Baseline} & 2.44 \times 10^{-4} & 0.0000 & 0.1783 & \text{Blocked (No Token)} \\
\text{Phase Error } (L_1) & \text{Baseline} & 2.44 \times 10^{-4} & 0.0000 & 0.0121 & \text{Blocked (No Token)} \\
\text{Mass Drift } (\Delta M) & 0.0000 & 0.0000 & 0.0000 & 0.0435 & \text{Blocked (No Token)} \\
\text{Phase-Mass Drift } (\Delta \Phi) & 0.0000 & 0.0000 & 0.0000 & 0.0029 & \text{Blocked (No Token)} \\
\hline
\end{array}$$
...
$$\mathbf{PHASE\ F36\ SCIENTIFIC\ CLASSIFICATION:\ LEVEL\ B}$$
