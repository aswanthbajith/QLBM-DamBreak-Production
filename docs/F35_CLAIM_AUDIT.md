# PHASE F35: SCIENTIFIC CLAIM AUDIT & HIERARCHY
...
5 & \text{Noisy emulation on 127-qubit hardware} & \textbf{DEMONSTRATED IN NOISY SIMULATOR} & \text{Executed on FakeSherbrooke with } L_1\text{ error } = 0.1812 \\
