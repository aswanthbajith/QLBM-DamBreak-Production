...
md_plan = """# TWO-PHASE QUANTUM LATTICE BOLTZMANN DAM-BREAK IMPLEMENTATION PLAN
...
"""
with open(os.path.join(research_dir, "TWO_PHASE_IMPLEMENTATION_PLAN.md"), "w") as f:
    f.write(md_plan.strip() + "\n")

print("Generated research/TWO_PHASE_IMPLEMENTATION_PLAN.md.")
