"""
Phase F29: Test Suite for 8x8 Scalable Quantum Circuit Execution and Inversion.
"""
...
def test_8x8_circuit_forward_and_inverse():
    """Verify single step and exact adjoint inversion on 8x8 grid."""
    circ = F29ScalableQuantumCircuit(nx=8, ny=8, frac_bits=12, bit_width=16)

    f_in = np.random.randint(100, 500, size=(9, 8, 8))
    g_in = np.random.randint(100, 500, size=(9, 8, 8))
