"""
Phase F36: Test Suite for Macroscopic Observables Reconstruction.
"""
...
def test_observables_reconstruction():
    ...
    fields = F36ObservablesReconstructor.reconstruct_from_counts(counts, nx=2, ny=2, bits_per_node=4)
