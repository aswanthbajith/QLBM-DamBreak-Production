"""
Phase F28: Independent Clean-Room 2x2 LBM Reference Engine.

Strict Anti-Circularity Implementation:
- Contains NO imports from quantum/
- Implements discrete D2Q9 two-phase BGK collision, coordinate streaming, and bounce-back from first principles
- Used for 100% independent verification of the gate-level 2x2 quantum circuit.
"""
...
class F28CleanRoom2x2Reference:
    """
    Independent 2x2 fixed-point LBM reference engine.
    """
    ...
    def step(
        ...
        """
        Executes one full independent 2x2 LBM step: BGK -> Streaming -> Boundary.
        """
        ...
        for i in range(9):
            ...
            f_next[opp_i] = f_streamed[i]
            g_next[opp_i] = g_streamed[i]
