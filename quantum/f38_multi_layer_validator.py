"""
Phase F38: Multi-Layer Hardware Validation Pipeline.
...
class F38MultiLayerValidator:
    """
    Executes and cross-validates all execution tiers for Phase F38.
    """
    ...
    def run_full_validation_matrix(shots: int = 4096) -> Dict[str, Any]:
        ...
        return {
            "credentials": F38BackendDiscovery.audit_credentials(),
            "ideal": ideal_res,
            "noisy": noisy_res,
            "real_qpu": qpu_res,
            "dry_run": dryrun_res,
